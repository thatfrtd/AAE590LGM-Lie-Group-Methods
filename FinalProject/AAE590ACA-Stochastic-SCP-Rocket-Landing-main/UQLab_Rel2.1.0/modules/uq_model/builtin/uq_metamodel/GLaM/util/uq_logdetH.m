...
%       v = logdet(C, 'chol');
%
%   Modified from the function logH provided by, Dahua Lin (dhlin@mit.edu)
%
%
%% argument checking
...
%         warning('The Hessian matrix is not well-conditioned, the KIC score is set to NaN');
        v = NaN;
    end
else
    [L, U, P] = lu(A);
