function pass = uq_GLaM_selftest(level)
uqlab('-nosplash');
...
TestNames = {'uq_GLaM_test_GLD', ...
    'uq_GLaM_test_complex_variance', ...
    'uq_GLaM_test_constants',...
    'uq_GLaM_test_transform',...
    'uq_GLaM_test_MultiOutput',...
    } ;
...
fprintf('\n%s\n',MinusLine);
fprintf('UQ_SELFTEST_UQ_GLaM RESULTS');
fprintf('\n%s\n',MinusLine);
...
if all(success)
    pass = 1;
    fprintf('\n');
    fprintf(['SUCCESS: uq_GLaM module ' level ' test was successful.\n']);
else
