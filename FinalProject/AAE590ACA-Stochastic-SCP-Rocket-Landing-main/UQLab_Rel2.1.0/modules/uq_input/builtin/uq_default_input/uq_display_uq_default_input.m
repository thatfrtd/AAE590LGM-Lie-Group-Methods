function H = uq_display_uq_default_input( module, inptArray, varargin )
...
if Min > 2 && ~marginals_flag
    ...
    H{end+1} = uq_figure('name', sprintf('Input Object: %s, Marginals: %s',...
...
elseif Min == 2 && ~marginals_flag
    ...
    for ii = 1 : Min
        ...
        figpos = get(H{end},'Position');
        add_width = 0.5*figpos(3);
        set(H{end},'Position',[figpos(1)-add_width/2 figpos(2) figpos(3)+add_width figpos(4)])
        % Get color map
