...
TestNames = {
    ...
    'uq_Reliability_test_linesampling_inout',...
    'uq_Reliability_test_linesampling_RS',...
    'uq_Reliability_test_linesampling_RS_const',...
    'uq_Reliability_test_linesampling_multiOut',...
    'uq_Reliability_test_linesampling_noRoot',...
    'uq_Reliability_test_linesampling_noGrad',...
    'uq_Reliability_test_bayesianlinesampling_inout',...
    'uq_Reliability_test_bayesianlinesampling_RS',...
    'uq_Reliability_test_bayesianlinesampling_RS_const',...
    'uq_Reliability_test_bayesianlinesampling_multiOut',...
    'uq_Reliability_test_bayesianlinesampling_noRoot',...
    'uq_Reliability_test_bayesianlinesampling_noGrad',...
     };
