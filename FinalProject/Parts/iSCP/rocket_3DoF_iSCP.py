...
from Code.SE2.SE2_maps import se2_exp, se2_tuplevec_to_mat
...
control_convex_constraints = [thrust_max_constraint, gimbal_constraint, bad_thrust_min_constraint]
...
print(thrust_min_constraint["func"]["val"](x_guess[:, 0:2], u_guess[:, 0:2], x_guess[:, 0:2], u_guess[:, 0:2], 0))
...
## Solve Problem
ptr_sol = iPTR(prob_3DoF, ptr_ops)
