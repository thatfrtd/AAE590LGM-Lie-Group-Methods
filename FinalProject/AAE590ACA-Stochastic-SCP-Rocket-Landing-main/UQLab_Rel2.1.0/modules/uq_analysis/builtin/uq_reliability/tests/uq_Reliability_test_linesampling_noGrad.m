function success = uq_Reliability_test_linesampling_noGrad(level)
% SUCCESS = UQ_RELIABILITY_TEST_LINESAMPLING_NOGRAD(LEVEL):
...
try
    ...
    ErrStr = sprintf('\nError in uq_Reliability_test_linesampling_noGrad\n');
    error(ErrStr)
end
