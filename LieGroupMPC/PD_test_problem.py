...
from Code.SE2.SE2_maps import se2_compose, se2_exp, se2_log, se2_wedge, se2_vee, se2_inverse, se2_jac_linv, se2_Ad
...
class PD_test_problem:
    ...
    def lie_algebra_error_rate(xi_e, eta, xi, xi_bar):
        xi_e_dot = se2_jac_linv @ xi_e @ (xi - se2_Ad(se2_inverse(eta)) @ xi_bar)
        return xi_e_dot