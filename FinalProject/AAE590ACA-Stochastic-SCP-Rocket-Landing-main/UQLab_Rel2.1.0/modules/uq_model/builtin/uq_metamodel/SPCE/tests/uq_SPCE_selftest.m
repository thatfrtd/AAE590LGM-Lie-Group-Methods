function pass = uq_SPCE_selftest(level)
uqlab('-nosplash');
...
TestNames = {'uq_SPCE_test_integration', ...
    'uq_SPCE_test_constant',...
    'uq_SPCE_test_latent',...
    'uq_SPCE_test_MultiOutput',...
    } ;
...
if all(success)
    pass = 1;
    fprintf('\n');
    fprintf(['SUCCESS: uq_SPCE module ' level ' test was successful.\n']);
else
